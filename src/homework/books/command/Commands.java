...
public interface Commands {
    ...
    static void printCommands() {
        ...
        System.out.println("please input " + PRINT_BOOKS_BY_AUTHOR_NAME + " for PRINT_BOOKS_BY_AUTHOR_NAME");
        System.out.println("please input " + PRINT_BOOKS_BY_GENRE + " for PRINT_BOOKS_BY_GENRE");
